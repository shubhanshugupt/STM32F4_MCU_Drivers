...
C_SRCS += \
../Src/009_spi_master.c \
../Src/syscalls.c \
../Src/sysmem.c 

OBJS += \
./Src/009_spi_master.o \
./Src/syscalls.o \
./Src/sysmem.o 

C_DEPS += \
./Src/009_spi_master.d \
./Src/syscalls.d \
./Src/sysmem.d 


# Each subdirectory must supply rules for building sources it contributes
Src/009_spi_master.o: ../Src/009_spi_master.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DSTM32 -DSTM32F407G_DISC1 -DSTM32F4 -DSTM32F407VGTx -DDEBUG -c -I../Inc -I"/home/shubh/workspace/STM32CubeIDE/workspace_1.5.1/stm32f4xx_drivers/drivers/Inc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Src/009_spi_master.d" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
